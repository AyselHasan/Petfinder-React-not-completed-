    ...
    <div className="footer-1 resp-d-none mt-3">
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-2">
            <p className="text-white fw-bold font-regular mt-3">PET ADOPTION</p>
            <br />
            <ul className="list-unstyled text-white font-regular font-size-13">
              <li>Dog Adoption</li>
              <br />
              ...
              <div className="social-media-icons">
                <ul className="list-unstyled d-flex font-size-20">
                  <li className="margin-right-25">
                    <a className="a-unstyled" href="https://www.facebook.com/" target="_blank">
                      <span aria-hidden="true" data-icon="" className="down-arrow" />
                    </a>
                  </li>
                  <li className="margin-right-25">
                    <a className="a-unstyled" href="https://twitter.com/?lang=tr" target="_blank">
                      <span aria-hidden="true" data-icon="" className="down-arrow" />
                    </a>
                  </li>
                  <li className="margin-right-25">
                    <a className="a-unstyled" href="https://www.instagram.com/?hl=tr" target="_blank">
                      <span aria-hidden="true" data-icon="" className="down-arrow" />
                    </a>
                  </li>
                  <li className="margin-right-25">
                    <a className="a-unstyled" href="https://www.youtube.com/" target="_blank">
                      <span aria-hidden="true" data-icon="" className="down-arrow" />
                    </a>
                  </li>
                  <li className="margin-right-25">
                    <a className="a-unstyled" href="https://tr.pinterest.com/" target="_blank">
                      <span aria-hidden="true" data-icon="" className="down-arrow" />
                    </a>
                  </li>
                </ul>
